...
<body class="bg-gray-50">
    <!-- Overlay -->
        ...
        <div id="sidebarMobile" class="sidebar-mobile">
            ...
            <div class="mt-8">
                <ul class="space-y-4">
                    <li><a href="#" class="block py-2 hover:text-blue-400 transition">📊 Dashboard</a></li>
                    <li><a href="{{ route('home') }}" class="block py-2 hover:text-blue-400 transition">📚 Libros</a></li>
                    <li><a href="{{ route('usuarios.index') }}" class="block py-2 hover:text-blue-400 transition">👥 Usuarios</a></li>
                    <li><a href="{{ route('prestamos.index') }}" class="block py-2 hover:text-blue-400 transition">🔄 Préstamos</a></li>
                    <li><a href="{{ route('categorias.index') }}" class="block py-2 hover:text-blue-400 transition">📂 Categorías</a></li>
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div id="mobileMenu" class="hidden md:flex flex-col md:flex-row md:items-center md:space-x-6 mt-4 md:mt-0">
                    ...
                    <a href="{{ route('home') }}" class="text-gray-600 hover:text-blue-600">Libros</a>
                    <a href="{{ route('usuarios.index') }}" class="text-gray-600 hover:text-blue-600">Usuarios</a>
                    <a href="{{ route('prestamos.index') }}" class="text-gray-600 hover:text-blue-600">Préstamos</a>
                    <a href="{{ route('categorias.index') }}" class="text-gray-600 hover:text-blue-600">Categorías</a>
