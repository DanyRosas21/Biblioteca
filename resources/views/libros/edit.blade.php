...
<main class="flex items-center justify-center min-h-screen px-4 py-8">
    ...
    <div class="w-full max-w-2xl fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-gray-800">Editar Libro</h2>
            <p class="text-gray-600">Modifica los datos del libro</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <form action="{{ route('libros.update', $libro->id) }}" method="POST" class="p-6">
                ...
                <div class="mb-5">
                    <label class="block text-gray-700 font-semibold mb-2">
                        <i class="fas fa-barcode mr-2 text-yellow-500"></i>
                        ISBN
                    </label>
                ...
                <div class="mb-5">
                    <label class="block text-gray-700 font-semibold mb-2">
                        <i class="fas fa-user-pen mr-2 text-yellow-500"></i>
                        Autor
                    </label>
                ...
                <div class="mb-6">
                    ...
                    <select name="category_id" required 
                        ...
                        @foreach($categorias as $category)
                            <option value="{{ $category->id }}" {{ $libro->category_id == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" 
                            class="order-1 sm:order-2 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-medium px-5 py-2 rounded-lg transition shadow-md hover:shadow-lg">
